...
def solve_ode_SEIQR(t, params):
    def odes(y, t, beta, sigma, gamma, delta):
        S, E, I, Q, R = y
...
def solve_ode_SEIQDRP(t, params):
    ...
    sol = odeint(odes, y, t, (params[7], params[8], params[9], params[10], params[11], params[12], params[13], params[14], params[15], params[16]))
